    ...
    <div
            ...
            >
                ...
                @method('PUT')
                    ...
                    :value="old('tags', $job->company_name)" />
                    ...
                    :value="old('tags', $job->contact_email)" />

                    <x-inputs.file id="company_logo" name="company_logo" label="Company Logo" />

                    <x-inputs.button type="submit" label="Save" />
                </form>
            </div>
</x-layout>